...
import { runCommand, runCommandAsPromise } from "../utils/exec.js";
...
export async function createProject({ projectName, projectPath, template, features, components, skipInstall }) {
  ...
  await runCommandAsPromise(`npm create vite@latest --yes ${projectName} -- --template ${viteTemplate}`, { stdio: "inherit" });
